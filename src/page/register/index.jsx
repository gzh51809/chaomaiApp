    ...
    render() {
        return (
            <div className={style.contain}>
                <Topbar title='注册' handleBack={() => { this.props.history.goBack() }} right handleRight={() => { this.props.history.push('/login') }} />
                            ...
                            return (
                                <div key={item.num}
                                    className={classNames({
                                        [style.item]: true,
                                        [style.borderBottom]: this.state.idx === item.num
                                    })}
                                    onClick={() => {
                                        this.setState({
                                            idx: item.num
