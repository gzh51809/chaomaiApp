    ...
    render(){
        ...
        return(
            <div className="Cart">
                ...
                <div className="empty-contents" style={{display:'none'}}>
                            ...
                            <div className="head-box flex-middle">
                                <div className="flex-item flex-middle">
                                    ...
                                    <div className="flex-item flex-middle">
                                        ...
                                        <span className="text-ellipsis">砚七三七</span>
                                        <svg data-v-8b9c5130=""  type="ios-arrow-right" size="20" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512"><path data-v-8b9c5130="" d="M160 115.4L180.7 96 352 256 180.7 416 160 396.7 310.5 256z"></path></svg>
                                    </div>
                                </div>
                                <div className="link">联系卖家</div>
                            </div>
                            <div className="contents">
                                <div className="product-item flex-middle">
                                    <div className="check">
                                        <i className={`iconfont ${open ? 'icon-xuanzhonggou' : 'icon-weixuan'}`}></i>
                                    </div>
                                    <div className="flex-item flex">
                                        <img src="http://buyshowimg.oss-cn-qingdao.aliyuncs.com/20180521%2F8eadea330011a56446211d82be4ed5f3.jpg?x-oss-process=image/resize,m_lfit,w_400,h_400" alt="" className="thumb"/>
                                        <div className="flex-item detail">
                                            ...
                                            <div className="multi-ellipsis name">
                                                砚七三七粉原产地文山三七超细粉150克X2瓶精品礼盒
                                            </div>
                                            <div className="tip text-ellipsis text-small">套餐: 默认</div>
                                            <div className="sub-info">
                                                <div className="price text-ellipsis">
                                                    ￥<span className="num">644.00</span>
                                                </div>
                                                <div className="check">
                                                    <span className="selector">-</span>
                                                    <input type="number" className="number-input" readOnly value='1'/>
                                                    <span className="selector">+</span>
                                                </div>
                                            </div>
                                        </div>
